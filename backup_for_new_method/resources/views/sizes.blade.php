    ...
    <div class="flex -mx-4">
        ...
        <div class="w-3/4 mx-4">
            ...
            <div class="flex justify-between w-full">
                <h3 class="text-xl font-semibold tracking-wide">Video Resolution Sizes</h3>
                <a href="/sizes/add">
                    <button type="button"
                ...
                <tbody>
                    ...
                    <tr style="text-align: center;">
                        ...
                        <td class="border px-4 py-2">
                            <a href="/sizes/delete/{{$size->id}}" onclick="return confirm('Are you sure you want to delete this size?');">
                                <button type="button"
