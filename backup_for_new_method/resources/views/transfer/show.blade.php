...
<head>
    ...
    <title>Planetnine Transfer - {{ $name }}</title>
    ...
    <main class="main">
        ...
        <div class="transfer_link">
            ...
            <div class="button_area">
                <button id="copy_button" onclick="copy_transfer_link()"><label id="button_text">Copy
                        Link</label></button>
                <button id="back_button" onclick="location.href='/p9_transfer'"><label
                        id="button_text">Back</label></button>
            </div>
        </div>
        @endif
        ...
        <div class="footer">
            <p>&copy; All Right Reserved.
                <a href="https://www.planetnine.com" target="_blank" style="color: white;">Planetnine</a> -
                <?= Date('Y') ?>
            </p>
        </div>
