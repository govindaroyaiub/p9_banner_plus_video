...
<div class="container mx-auto px-4">
    <div class="flex -mx-4">
        ...
        <div class="w-3/4 mx-4">
            ...
            <h3 class="text-xl font-semibold tracking-wide">Edit Banners</h3>
            ...
            <form id="project-add-form" class="max-w-xl py-3" method="POST"
                action="/banner/edit/version/{{$main_project_id}}/{{$version_id}}" enctype="multipart/form-data">
                @csrf
                {{-- Drag and Drop --}}
                <input type='text' placeholder="{{ $version_name }}" name="version_title" value="{{ $version_name }}" id="version_title"
