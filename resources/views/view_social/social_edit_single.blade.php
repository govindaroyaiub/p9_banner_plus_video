...
<div class="container mx-auto px-4">
    <div class="flex -mx-4">
        ...
        <div class="w-3/4 mx-4">
            @include('alert')
            <h3 class="text-xl font-semibold tracking-wide">Edit Social Image</h3>
            <br>

            <form id="project-add-form" class="max-w-xl" method="POST"
                action="/social/edit/{{ $id }}" enctype="multipart/form-data">
                @csrf
                {{-- Drag and Drop --}}
                ...
                <div
                    ...
                    <input name="upload" id="upload" type="file" accept="zip,application/octet-stream,application/zip,application/x-zip,application/x-zip-compressed">
                </div>
