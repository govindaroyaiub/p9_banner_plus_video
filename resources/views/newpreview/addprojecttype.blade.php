...
<div class="container mx-auto px-4">
    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
        <div class="mdc-card p-8 flex align-items-center rounded-lg">
                @include('alert')
                <h3 class="text-xl font-semibold tracking-wide mb-4 mt-2">Add More Creatives</h3>
                <h3 class="text-xl font-semibold tracking-wide mb-4 mt-2">Adding To Project: <label style="color: red;">{{ $project['name'] }}</label></h3>
                <form id="project-add-form" class="max-w-4xl" method="POST" action="/project/preview/add/FeedbackOrProjectType/{{ $project['id'] }}"
                    ...
                    <div class="flex flex-col md:flex-row gap-4 mb-4">
                        <!-- Version Name -->
                        <div class="w-full md:w-1/2" id="version_name">
