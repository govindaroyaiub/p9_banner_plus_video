...
<div class="container mx-auto px-4">
    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
        <div class="mdc-card p-8 flex align-items-center rounded-lg">
            @include('alert')
            <h3 class="text-xl font-semibold tracking-wide mt-2">Edit Gif To Version</h3>
            <br>
            ...
            <form id="project-add-form" class="max-w-4xl" method="POST"
                action="/project/preview/gif/edit/version/{{ $version['id'] }}" enctype="multipart/form-data" style="width: 100%;">
                @csrf
                {{-- Drag and Drop --}}
