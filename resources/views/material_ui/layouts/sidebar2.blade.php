            ...
            <nav class="mdc-list mdc-drawer-menu">
                ...
                <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link {{ request()->is('view-previews') || request()->is('project/preview/*') ? 'active' : '' }}" href="/view-previews">
                        <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">fiber_new</i>
                        New Preview System
                    </a>
                </div>
                <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link {{ request()->is('p9_transfer') || request()->is('p9_transfer/*') ? 'active' : '' }}" href="/p9_transfer">
                        <i class="material-icons mdc-list-item__start-detail mdc-drawer-item-icon" aria-hidden="true">attach_file</i>
                        Files Transfer
                    </a>
                </div>
                <div class="mdc-list-item mdc-drawer-item">
                ...
                <div class="mdc-list-item mdc-drawer-item">
                    ...
                    <div class="mdc-expansion-panel" id="old_entries_v2">
                        <nav class="mdc-list mdc-drawer-submenu">
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="/banner-showcase">
                                    Banner Showcase
                                </a>
                            </div>
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="/video-showcase">
                                    Video Showcase
                                </a>
                            </div>
                        </nav>
                ...
                <div class="mdc-list-item mdc-drawer-item">
                    ...
                    <div class="mdc-expansion-panel" id="old_entries_v1">
                        <nav class="mdc-list mdc-drawer-submenu">
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="/banner">
                                    Banner
                                </a>
                            </div>
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="/video">
                                    Video
                                </a>
                            </div>
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="/gif">
                                    Gif
                                </a>
                            </div>
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="/social">
                                    Social
                                </a>
                            </div>
                        </nav>
                ...
                <div class="mdc-list-item mdc-drawer-item">
                    ...
                    <div class="mdc-expansion-panel" id="sizes-menu">
                        <nav class="mdc-list mdc-drawer-submenu">
                            ...
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="/logo">
                                    Clients
                                </a>
                            </div>
                            <div class="mdc-list-item mdc-drawer-item">
