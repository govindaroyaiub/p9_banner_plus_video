        ...
        <div class="w-3/4 mx-4">
            ...
            <form method="POST" action="/project/banner/edit/{{$id}}" enctype="multipart/form-data">
                ...
                <input type='text' value="{{ $naming_convention }}_" id="naming_convention"
                    class="w-1/3 mt-2 mb-6 px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:border-primary" readonly/>
                <button type="button" onclick="copy_text()"
                    class="bg-green-500 text-gray-200 rounded hover:bg-green-400w-1/3 mt-2 mb-6 px-4 py-2 focus:outline-none">
