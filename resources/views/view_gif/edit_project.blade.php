...
<div class="container mx-auto px-4">
    <div class="flex -mx-4">
        ...
        <div class="w-3/4 mx-4">
            @include('alert')
            <h3 class="text-xl font-semibold tracking-wide">Edit GIF Project</h3>
            <br>
            <form method="POST" action="/project/gif/edit/{{$id}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex mb-4">
                    ...
                    <button type="button" onclick="window.location.href ='/gif'"
