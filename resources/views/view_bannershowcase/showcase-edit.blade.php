...
<div class="container mx-auto px-4">
    <div class="flex -mx-4">
        ...
        <div class="w-3/4 mx-4">
            @include('alert')
            <h3 class="text-xl font-semibold tracking-wide">Edit Showcase Project</h3>
            <br>
            <form method="POST" action="/project/banner-showcase/edit/{{$project_id}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex">
                    <input type='text' value="{{ $naming_convention }}_" id="naming_convention"
                        class="w-1/2 mr-4 px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:border-primary" readonly/>
                    <button type="button" onclick="copy_text()"
                        class="bg-green-500 text-gray-200 rounded hover:bg-green-400w-1/3 px-2 focus:outline-none" style="height: 2.5rem; width: 9rem;">
                        <svg class="w-6 h-6 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="margin: 0 auto;">
