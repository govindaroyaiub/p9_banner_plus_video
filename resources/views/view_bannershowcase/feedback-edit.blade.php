    ...
    <div class="flex -mx-4">
        ...
        <div class="w-3/4 mx-4">
            ...
            <form id="project-add-form" class="max-w-xl py-3" method="POST"
                ...
                <div
                    class="drop-zone border-2 border-dotted mt-4 border-indigo-400 rounded-lg p-6 cursor-pointer justify-center items-center font-2xl font-semibold text-indigo-400 hidden" id="upload_section">
...
<script>
    $(document).ready(function () {
        $('#upload_new_files').change(function (){
            if($("#upload_new_files").is(':checked')){
                // Code in the case checkbox is checked.
                document.getElementById("upload_section").style.display = 'flex';
            } else {
