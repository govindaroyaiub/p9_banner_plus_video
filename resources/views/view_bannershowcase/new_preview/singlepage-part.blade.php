        ...
        <div class="container mx-auto px-4 py-4">
            <div class="banners" style="text-align: center;">
                ...
                <?php
                    ...
                    $height = $resolution[1];
                ?>
                <div class="single-div" style="width: {{$width}}px;">
                    <div class="info_texts" style="display: flex; justify-content: space-between;">
                        <small>{{ $width }}x{{ $height }}</small>
                        <small class="text-red-700 size_text">{{ $bannerSize }}</small>
                    </div>
