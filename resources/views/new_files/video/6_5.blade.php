...
<div class="md:w-3/4 mx-8">
    <div class="videos">
        <div class="md:flex">
            ...
            <div class="video-container" style="aspect-ratio: 1.2/1; width: 336px; height: 280px;">
                <video class="video" playsinline controls controlsList="nodownload" data-poster="poster.jpg">
            ...
            <ul class="flex space-x-4 icons" style="color: {{ $main_project_info['color'] }};">
                ...
                @if(Auth::user())
                    <li><a href="/video-showcase/edit/{{ $project->id }}"
                        ...
                        @if(Helper::getVideoCountInsideFeedback($project->id) > 1)
                        <li>
                            <a href="/video-showcase/delete/{{ $project->id }}"
